"""Public API for pyml's decision tree models.

Lazily exposes decision tree estimators (DecisionTreeClassifier,
DecisionTreeRegressor), so that importing pyml.tree does not eagerly
load their contents.
"""
...
_LAZY_IMPORTS = {
    "DecisionTreeClassifier": ("decision_tree_classifier", "DecisionTreeClassifier"),
    "DecisionTreeRegressor": ("decision_tree_regressor", "DecisionTreeRegressor"),
}
